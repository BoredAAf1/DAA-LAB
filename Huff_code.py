...
if __name__ == "__main__":
    compress_file("compression_text1.txt")
    compress_file("compression_text2.txt")
    compress_file("compression_text3.docx")
    compress_file("compression_text4.html")
    compress_file("compression_text5.pdf")
